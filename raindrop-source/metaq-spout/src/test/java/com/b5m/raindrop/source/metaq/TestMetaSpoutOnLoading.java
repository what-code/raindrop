...
public class TestMetaSpoutOnLoading {
	public static final String TOPIC_NAME = "spout-test";
	private final static Logger logger = Logger.getLogger(TestMetaSpoutOnLoading.class);
	...
	private StormTopology createStormTopology(){
		...
		builder.setSpout("goodsid", metaSpout, 10); 
	...
	private Thread[] multiThreadExecuteProduce(int threadCount, final CountDownLatch latch){
	...
	private void startUpThreads(Thread[] threads){
	...
	@Test
	public void testSpout() throws MetaClientException, InterruptedException {
        ...
        startUpThreads(multiThreadExecuteProduce(threadCount, latch));
        latch.await();
        Utils.sleep(10000);
