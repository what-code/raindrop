...
public class MetaSpout implements IRichSpout {
    ...
    private void logMetaClientConfig(MetaClientConfig config){
    	if(!log.isDebugEnabled())
    		return ;
    	log.debug(new StringBuilder("Meta Client Config:{").append(config.getServerUrl())
    			.append(", diamondPartitionsDataId->").append(config.getDiamondPartitionsDataId())
    			.append(", diamondPartitionsGroup->").append(config.getDiamondPartitionsGroup())
    			.append(", recoverMessageIntervalInMills->").append(config.getRecoverMessageIntervalInMills())
    			.append(", recoverThreadCount->").append(config.getRecoverThreadCount())
    			.append(", partitionsInfo->").append(config.getPartitionsInfo())
    			.append(", ").append(logZkConfig(config.getZkConfig()))
    			.append("}").toString());
    }
    
    private String logZkConfig(ZKConfig config){
    	if(null == config)
    		return "zkConfig->null";
    	return new StringBuilder("zkConfig:{").append(config.zkConnect)
    			.append(", zkConnectionTimeoutMs->").append(config.zkConnectionTimeoutMs)
    			.append(", zkEnable->").append(config.zkEnable)
    			.append(", zkRoot->").append(config.zkRoot)
    			.append(", zkSessionTimeoutMs->").append(config.zkSessionTimeoutMs)
    			.append(", zkConfig{zkConnect->").append(config.zkSyncTimeMs)
    			.append("} ").toString();
    }

    private void logConsumerConfig(ConsumerConfig consumerConfig){
    	if(!log.isDebugEnabled())
    		return ;
    	log.debug(new StringBuilder("Consumer Config:{consumerId->").append(consumerConfig.getConsumerId())
    			.append(", commitOffsetPeriodInMills->").append(consumerConfig.getCommitOffsetPeriodInMills())
    			.append(", diamondPartitionsDataId->").append(consumerConfig.getDiamondPartitionsDataId())
    			.append(", diamondPartitionsGroup->").append(consumerConfig.getDiamondPartitionsGroup())
    			.append(", fetchRunnerCount->").append(consumerConfig.getFetchRunnerCount())
    			.append(", fetchTimeoutInMills->").append(consumerConfig.getFetchTimeoutInMills())
    			.append(", group->").append(consumerConfig.getGroup())
    			.append(", maxDelayFetchTimeInMills->").append(consumerConfig.getMaxDelayFetchTimeInMills())
    			.append(", maxFetchRetries->").append(consumerConfig.getMaxFetchRetries())
    			.append(", maxIncreaseFetchDataRetries->").append(consumerConfig.getMaxIncreaseFetchDataRetries())
    			.append(", offset->").append(consumerConfig.getOffset())
    			.append(", partition->").append(consumerConfig.getPartition())
    			.append(", recoverMessageIntervalInMills->").append(consumerConfig.getRecoverMessageIntervalInMills())
    			.append(", recoverThreadCount->").append(consumerConfig.getRecoverThreadCount())
    			.append(", serverUrl->").append(consumerConfig.getServerUrl())
    			.append(", loadBalanceStrategyType->").append(consumerConfig.getLoadBalanceStrategyType())
    			.append(", partitionsInfo->").append(consumerConfig.getPartitionsInfo())
    			.append(", ").append(logZkConfig(consumerConfig.getZkConfig()))
    			.append("}").toString());
    }
    ...
    public void open(final Map conf, final TopologyContext context, final SpoutOutputCollector collector) {
        ...
        try {
        	...
        	logConsumerConfig(this.consumerConfig);
        	logMetaClientConfig(this.metaClientConfig);
    ...
    private void setUpMeta(final String topic, final Integer maxSize) throws MetaClientException {
        ...
        this.messageConsumer.subscribe(topic, maxSize, new MessageListener() {
            ...
            public void recieveMessages(final Message message) {
                ...
                if(log.isDebugEnabled()){
	                log.debug(new StringBuilder("InQueue : ").append(message.getId()).append(", partition:")
	                		.append(message.getPartition()).append(", total received count:")
	                		.append(receivedCount.incrementAndGet()).toString());
                }
