...
import com.b5m.plugin.spout.MetaSpout;
import com.b5m.plugin.spout.SignalSpout;
import com.b5m.plugin.spout.StringScheme;
...
public class ExclamationTopology {
	...
	public static void main(String[] args) throws Exception {
		...
		*/
		...
		builder.setBolt("bolt2", bolt2,8).fieldsGrouping("bolt1", new Fields("cat")).allGrouping("test_signal", "signals");
